...
export const Contact = () => {
  ...
  return (
    <>
      <Box id="contactBox" data-aos="fade-in">
        <Box id="myContactBox">
          <Typography id="getInTouch">&bull; Get in touch! &bull;</Typography>
          <Typography id="keepInTouch">Address: Tel Aviv, Israel</Typography>
          <Typography id="keepInTouch">Tel: (972) 052 868 9993</Typography>
          <Typography id="keepInTouch">
